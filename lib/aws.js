...
class AwsClient {
   ...
   * @returns {array} An array of users within that path
   */
  getUsers (pathPrefix = '/') {
   ...
   * @returns {object} An object containing `oldkey` and key materia for the new key
   */
   ...
   * @returns {array} An array with basic information about keys attached to the user
   */
